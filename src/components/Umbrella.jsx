        ...
        <>
            <div className="w-full flex justify-center items-center flex-col gap-4 bg-[#F4F6F8] p-5 py-8">
                ...
                <ul class="grid grid-cols-2 gap-4  open-sans-font">
                    <li className='flex items-start  gap-1'><IoUmbrellaOutline className='text-[#E60304] text-lg mt-1 shrink-0' />3D Construction LLC - Abu Dhabi</li>
                    <li className='flex items-start  gap-1'><IoUmbrellaOutline className='text-[#E60304] text-lg mt-1 shrink-0' />3D Construction LLC - Ajman</li>
                    <li className='flex items-start  gap-1'><IoUmbrellaOutline className='text-[#E60304] text-lg mt-1 shrink-0' />3D Construction LLC - Sharjah</li>
                    <li className='flex items-start  gap-1'><IoUmbrellaOutline className='text-[#E60304] text-lg mt-1 shrink-0' />3D Construction LLC - United Kingdom</li>
