    ...
    return (
        <>
            <div className="w-full flex  md:flex-row flex-col justify-between items-center px-5 py-10">
                <div id='about-text' className="flex gap-5 flex-col  md:w-[60%] w-full pr-10" xyz="fade left duration-5">
                ...
                <div  id='about-image'  className="flex flex-col w-[90%] md:w-[40%] md:h-[420px] h-[200px] bg-dark-radial md:mt-0 mt-10" xyz="fade right" >
