                ...
                <div className="grid grid-cols-3 gap-0.5">
                    <div className="col-span-1 py-3 flex items-center justify-center">
                        ...
                        <div className="text-start">
                            ...
                            <a href="https://goo.gl/maps/arxRfnbcY5eMcuaf9">
                                <div  className="flex hover:text-[#007EF6] duration-100 flex-col">
                                    <span>Office 918, Business Village</span>
                                    <span className='-mt-1'>Block B Port Saeed, Dubai</span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div className="col-span-1 border-l border-r py-3 flex items-center justify-center">
                        ...
                        <div className="text-start">
                            ...
                            <a href='mailto:info@3dconstractionllc.com' className='hover:text-[#007EF6] duration-100'>info@3dconstractionllc.com</a>
                        </div>
                    </div>
                    <div className="col-span-1 py-3 flex items-center justify-center">
                        ...
                        <div className="text-start">
                            ...
                            <a href='tel:+971565301894' className='hover:text-[#007EF6] duration-100'>+971521675135</a>
                        </div>
                    </div>
                </div>
            </div>
